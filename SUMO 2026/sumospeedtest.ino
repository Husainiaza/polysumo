...
const char* nama_bluetooth = "KKSJSumo4";
...
void setup() {
 ...
 //analogWriteFrequency(motorkananA1, 5000);
 //analogWriteFrequency(motorkananA2, 5000);
 // analogWriteFrequency(motorkiriB1, 5000);
 // analogWriteFrequency(motorkiriB2, 5000);
